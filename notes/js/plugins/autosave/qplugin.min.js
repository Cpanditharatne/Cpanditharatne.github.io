tinymce._beforeUnloadHandler = function() {
    ...
    return tinymce.each(tinymce.editors, function(b) {
       b.plugins.autosave && b.plugins.autosave.storeDraft(), !a && b.isDirty() && b.getParam("autosave_ask_before_unload", !0) && (a = b.translate("sssYou have unsaved changes in your notes. Are you sure you want to navigate away?"))
    }), a
